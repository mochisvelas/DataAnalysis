...
--Metadata
	...
	EXEC sys.sp_addextendedproperty 
     @name = N'Desnormalizacion', 
     @value = N'La dimension materia provee una vista desnormalizada de la tabla origen Materia en una sola dimensión para un modelo estrella', 
     @level0type = N'SCHEMA', 
     @level0name = N'Dimension', 
     @level1type = N'TABLE', 
	...
	EXEC sys.sp_addextendedproperty 
     @name = N'Desnormalizacion', 
     @value = N'La dimension descuento provee una vista desnormalizada de la tabla origen Descuento en una sola dimensión para un modelo estrella', 
     @level0type = N'SCHEMA', 
     @level0name = N'Dimension', 
     @level1type = N'TABLE', 
...
--Dimensiones
	...
	SELECT D.ID_Descuento,
			D.Descripcion as DescripcionDescuento,
...
--------------------------------------------------------------------------------------------	
	...
	FROM	Fact.Examen AS E INNER JOIN
			...
			Dimension.Materia AS M ON E.SK_Materia = M.SK_Materia INNER JOIN
			Dimension.Descuento AS D ON E.SK_Descuento = D.SK_Descuento INNER JOIN
